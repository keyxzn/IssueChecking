...
const DUMMY_ROWS: Row[] = [
  ...
  {
    id: 2,
    full_name: "IKN Nusantara",
    email: "isu-ikn@internal.id",
  ...
  {
    id: 3,
    full_name: "Kasus Korupsi BJB",
    email: "isu-bjb@internal.id",
...
const RISK_CATS = [
  { label:"Fraud / Penipuan",    key:"professional_risk", color:"#ef4444", track:"rgba(239,68,68,0.12)" },
...
export default function DashboardPage() {
  ...
  const CARDS = [
    { label:"Total Issue", val:total,                     sub:`${processing} diproses`,  icon:Users,      style:{ background:"var(--bg2)", border:"1px solid var(--border)" }, iStyle:{ background:"var(--bg3)", color:"var(--text3)" }, vColor:"var(--text)", href:"/candidates" },
