...
export default function BulkHistoryPage() {
  ...
  const stats = {
    ...
    candidates:sessions.reduce((a, s) => a + s.totalIssues, 0),
  };
      ...
      <div style={{ minHeight: "100vh" }}>
        ...
        <div style={{ background: "var(--bg2)", borderBottom: "1px solid var(--border)", padding: "24px 32px" }}>
          <div style={{ maxWidth: 1040, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
            ...
            <Link href="/candidates/bulk/new" className="btn btn-primary" style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div style={{ maxWidth: 1040, margin: "0 auto", padding: "24px 32px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, marginBottom: 24 }}>
            {[
              ...
              { label: "Total Issue", val: stats.candidates, icon: Users,           color: "var(--accent)" },
            ].map((s) => (
          ...
          {sessions.length === 0 ? (
            <div className="card" style={{ textAlign: "center", padding: "80px 0" }}>
              ...
              <Link href="/candidates/bulk/new" className="btn btn-primary" style={{ display: "inline-flex", gap: 8 }}>
              ...
              {sessions.map((s, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* CTA */}
                    <Link href="/candidates" style={{ display: "flex", alignItems: "center", gap: 4, fontSize: 12, fontWeight: 600, color: "var(--accent)", textDecoration: "none", whiteSpace: "nowrap" }}>
